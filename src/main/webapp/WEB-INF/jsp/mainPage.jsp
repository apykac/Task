...
<ul>
    ...
    <li><a href="${pageContext.request.contextPath}/method/get_organization/by_name">Поиск организации по
        Наименованию</a></li>
    <li><a href="${pageContext.request.contextPath}/method/get_organization/by_address">Поиск организации по Адресу</a>
    </li>
</ul>
</body>
</html>
